    ...
    <div className="container flex-grow-1">
      ...
      <div className="row">
        <div className="text-center">
          <h2>Dowóz</h2>
          <p>
            Oferujemy dowóz do wszystkich dzielnic Wrocławia, a także możliwość
            własnego odebrania zamówienia. Lorem ipsum, dolor sit amet
            consectetur adipisicing elit. Perspiciatis blanditiis dolorem quidem
            ducimus ipsa dolores alias placeat unde modi, esse ad, delectus
            nihil quasi beatae voluptas tempora nemo sed voluptatum!
          </p>
        </div>
      </div>
    </div>
